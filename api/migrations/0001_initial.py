# Generated by Django 3.2.18 on 2023-04-30 15:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to='images/users_images')),
        ...
        migrations.CreateModel(
            name='Artist',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='artist', serialize=False, to='api.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_file', models.FileField(upload_to='tracks/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp3'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('playlists', models.ManyToManyField(blank=True, related_name='categories', to='api.Playlist')),
            ],
        ),
        migrations.CreateModel(
            name='Follower',
